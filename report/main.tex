...
\lstinputlisting{code_samples/bulktransfer_sample.java}

\section{USB Serial by mik3y}

\lstinputlisting{code_samples/mik3y_sample.java}

\section{USB Serial by felHR85}

\lstinputlisting{code_samples/felhr85async_sample.java}
\lstinputlisting{code_samples/felhr85sync_sample.java}
...
\lstinputlisting{code_samples/facedetectorapi_sample.java}
...
\lstinputlisting{code_samples/cameraapi_sample.java}

\section{openCV for Android}
% detection in user's code

\lstinputlisting{code_samples/opencv_sample.java}
